...
function mountResultLanguage(data, language) {
	jQuery(data).each(function() {
...
function mountResultOrder(data, order) {
	jQuery(data).each(function() {
	});
}

jQuery('#filter-language').change(function() {
	var language = jQuery('#filter-language').val();
	...
	jQuery.ajax({
		...
		success: function(data) {
			...
			mountResultLanguage(data, language);
		}
	});
});
